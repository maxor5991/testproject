...
<body class="gray-bg">
    ...
    <div class="middle-box text-center loginscreen animated fadeInDown">
        <div>
            ...
            <h3>Bienvenido a GSN</h3>
                <!--Continually expanded and constantly improved Inspinia Admin Them (IN+)-->
            </p>
            <form class="m-t" method="post" accept-charset="utf-8" action="login.php" name="loginform" autocomplete="off" role="form">
            <?php
                ...
                <button name="login" id="submit" class="btn btn-danger block full-width m-b">Login</button>
            </form>
        </div>
    </div>
